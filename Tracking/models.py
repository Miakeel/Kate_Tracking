...
class Participant(models.Model):
    ...
    institution=models.CharField(null=False, max_length=300, default="")
    email=models.EmailField(null=False, max_length=50, unique=False, default="")
    title=models.CharField(null=False, max_length=50)
    phone=models.CharField(blank=True,max_length=40, default="")
    city=models.CharField(null=False, max_length=50, default="")
    country=models.CharField(null=False, max_length=50, default="")
